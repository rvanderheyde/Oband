...
function drawDifficultyButtons(canvas){
  ...
  var rect1 = canvas.drawRect(canvas.width/48, 158, canvas.width/8, 48)
  var rect2 = canvas.drawRect(canvas.width/48, 218, canvas.width/8, 48)
  var rect3 = canvas.drawRect(canvas.width/48, 278, canvas.width/8, 48)
  var rect4 = canvas.drawRect(canvas.width/48, 338, canvas.width/8, 48)
  canvas.setPenColor('#000000')
  canvas.setFont('Bold 24px Arial')
  var but1 = canvas.drawText('Easy', canvas.width/24, 188)
  var but2 = canvas.drawText('Medium', canvas.width/24, 248)
  var but3 = canvas.drawText('Hard', canvas.width/24, 308)
  var but4 = canvas.drawText('Expert', canvas.width/24, 368)
...
function drawInstrumentButtons(canvas){
  //takes the canvas and returns the rect and text
  canvas.setPenColor('#656565')
  var rect5 = canvas.drawRect(canvas.width/6+30, 158, canvas.width/8, 48)
  var rect6 = canvas.drawRect(canvas.width/6+30, 218, canvas.width/8, 48)
  var rect7 = canvas.drawRect(canvas.width/6+30, 278, canvas.width/8, 48)
  var rect8 = canvas.drawRect(canvas.width/6+30, 338, canvas.width/8, 48)
  canvas.setPenColor('#000000')
  canvas.setFont('Bold 24px Arial')
  var intr1 = canvas.drawText('Guitar', canvas.width/6+60, 188)
  var intr2 = canvas.drawText('Bass', canvas.width/6+60, 248)
  var intr3 = canvas.drawText('Piano', canvas.width/6+60, 308)
  var intr4 = canvas.drawText('Drums', canvas.width/6+60, 368)
